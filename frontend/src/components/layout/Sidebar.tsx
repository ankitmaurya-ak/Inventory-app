...
import {
    LayoutDashboard, Package, Users, Bell, History, LogOut, Package2, ChevronRight, Settings
} from 'lucide-react';
...
export default function Sidebar({ currentPath }: SidebarProps) {
    ...
    return (
        <aside className="fixed left-0 top-0 bottom-0 w-64 bg-white dark:bg-gray-900 border-r border-gray-200 dark:border-gray-800 flex flex-col z-40 shadow-sm">
            {/* Logo + Store Name */}
